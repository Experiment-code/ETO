...
# call the tunning methods----------------------------------------------------------------------
log_file_ansor = "logfile_end2end_ansor_resnet50.json"
infor_file_ansor = "inforfile_end2end_ansor_resnet50.py"
tune_END2END_ansor(tasks_ansor, task_weights_ansor, log_file_ansor, infor_file_ansor)


log_file = "logfile_end2end_eto_resnet50.json"
infor_log_file = "inforfile_end2end_eto_resnet50.py"
tune_END2END_hrc(tasks_list,
	search_tasks_list,
	loops_list,
	[selected_op_pairs,],
...
log_file_st = "logfile_end2end_st_resnet50.json"
all_infor_ST_file = "inforfile_end2end_st_resnet50.py"
END2END_ST_variants(log_file_st, all_infor_ST_file, 
	"vary_K", 3, 
	search_tasks_list, 
	loops_list)
